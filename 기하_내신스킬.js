(function(){
  ...
  if(!skill){root.innerHTML='<div class="skill-not-found"><h1>스킬을 찾을 수 없습니다.</h1><p>기하 메인에서 다시 선택해주세요.</p><a href="기하.html">기하 메인으로 돌아가기</a></div>';return}
