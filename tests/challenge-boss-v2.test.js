...
assert.match(skillHtml, /미적분1_계산스킬\.js\?v=18/);
assert.match(skillHtml, /미적분1_계산스킬\.css\?v=21/);
...
assert.match(skillJs, /requiresFinisher=stitchBattle&&!completingStitch\|\|forbiddenBattle&&!breakingForbiddenSeal/,'연속의 봉합사와 금단의 미분술사는 각각의 완성 공격으로만 쓰러져야 한다.');
