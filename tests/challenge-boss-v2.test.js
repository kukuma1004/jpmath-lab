...
assert.match(skillHtml, /미적분1_계산스킬\.js\?v=12/);
assert.match(skillHtml, /미적분1_계산스킬\.css\?v=10/);
...
assert.match(skillJs, /function makeQuestion\(id,level=currentLevel\)/,'보스 페이즈 난도가 실제 문제 생성기에 전달되어야 한다.');
